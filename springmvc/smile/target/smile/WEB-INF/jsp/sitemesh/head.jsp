...
<div id="slider" class="group inner">
    <ul class="group">
        <li class="first slide-1 group image-content-type">
            <div class="slider-featured group"><a href="http://www.google.it"><img src="${ctxStatic}/images/banner2.jpg" width="960" height="338" alt="interior design" /></a></div>
        ...
        <li class="slide-2 group image-content-type">
            <div class="slider-featured group"><img src="${ctxStatic}/images/bg-homepage.jpg" width="960" height="338" alt="Luxury gold" /></div>
            <div class="slider-caption caption-right">
                <!-- TITLE -->
                <h2>真诚期待与您合作</h2>
                <!-- TEXT -->
