...
<c:set var="ctxStatic" value="${pageContext.request.contextPath}/static"/>--%>
     ...
     <%--   <div id="copyright" class="group two-columns">
        ...
        <div class="box-sections">
            <img src="${ctxStatic}/app/images/icons/set_icons/phone-black.png" width="32" height="32" alt="Customer support" class="icon" />
        ...
        <div class="box-sections">
            <img src="${ctxStatic}/app/images/icons/set_icons/chart-bar.png" width="32" height="32" alt="Marketing" class="icon" />
        ...
        <div class="box-sections2"  >
            <img src="${ctxStatic}/app/images/icons/set_icons/checkbox-checked.png"  height="32" alt="Free shipping" class="icon" />
